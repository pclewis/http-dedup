...
(def cli-options
  [["-l" "--listen [HOST:]PORT" "Listen address"
   ...
   [nil "--max-buffers N" "Maximum ByteBuffers to allocate"
    :default 2048
    :parse-fn #(Integer/parseInt %)]
   [nil "--buffer-size BYTES" "Size of each ByteBuffer in bytes"
    :default 32768
    :parse-fn #(Integer/parseInt %)]
   [nil "--request-timeout MS" "Max time to wait for client to send request in ms"
    :default 60000
    :parse-fn #(Integer/parseInt %)]])
